...
const mongolianLocations: Record<string, string[]> = {
  ...
  'Баянхонгор': ['Баянхонгор сум', 'Баацагаан сум', 'Баян-Овоо сум (Баянхонгор)', 'Баян-Өндөр сум (Баянхонгор)', 'Баянбулаг сум (Баянхонгор)', 'Баянговь сум', 'Баянлиг сум', 'Богд сум (Баянхонгор)', 'Бөмбөгөр сум', 'Бууцагаан сум', 'Галуут сум', 'Гурванбулаг сум (Баянхонгор)', 'Жаргалант сум (Баянхонгор)', 'Жинст сум', 'Заг сум', 'Хүрээмарал сум', 'Өлзийт сум (Баянхонгор)', 'Эрдэнэцогт сум'],
  'Булган': ['Булган сум (Булган)', 'Баян-Агт сум', 'Баяннуур сум (Булган)', 'Бугат сум (Булган)', 'Бүрэгхангай сум', 'Гурванбулаг сум (Булган)', 'Дашинчилэн сум', 'Могод сум', 'Орхон сум (Булган)', 'Рашаант сум', 'Сайхан сум (Булган)', 'Сэлэнгэ сум (Булган)', 'Тэшиг сум', 'Хангал сум', 'Хишиг-Өндөр сум', 'Хутаг-Өндөр сум'],
  ...
  'Говьсүмбэр': ['Сүмбэр сум', 'Баянтал сум', 'Шивээговь сум'],
  'Дархан-Уул': ['Дархан сум', 'Хонгор сум', 'Орхон сум (Дархан-Уул)', 'Шарынгол сум'],
  'Дорноговь': ['Сайншанд сум', 'Айраг сум', 'Алтанширээ сум', 'Даланжаргалан сум', 'Дэлгэрэх сум', 'Замын-Үүд сум', 'Иххэт сум', 'Мандах сум (Дорноговь)', 'Өргөн сум', 'Сайхандулаан сум', 'Улаанбадрах сум', 'Хатанбулаг сум', 'Хөвсгөл сум (Дорноговь)', 'Эрдэнэ сум (Дорноговь)'],
  'Дорнод': ['Чойбалсан сум', 'Баян-Уул сум (Дорнод)', 'Баянтүмэн сум', 'Баяндун сум', 'Булган сум (Дорнод)', 'Гурванзагал сум', 'Дашбалбар сум', 'Матад сум', 'Сэргэлэн сум (Дорнод)', 'Халхгол сум', 'Хөлөнбуйр сум', 'Цагаан-Овоо сум', 'Чулуунхороот сум'],
  'Дундговь': ['Мандалговь сум', 'Адаацаг сум', 'Баянжаргалан сум (Дундговь)', 'Говь-Угтаал сум', 'Гурвансайхан сум (Дундговь)', 'Дэлгэрхангай сум', 'Дэлгэрцогт сум', 'Дэрэн сум', 'Луус сум', 'Өлзийт сум (Дундговь)', 'Өндөршил сум', 'Сайхан-Овоо сум', 'Сайханзайн сум (Дундговь)', 'Хулд сум', 'Цагаандэлгэр сум', 'Эрдэнэдалай сум'],
  'Завхан': ['Улиастай сум', 'Алдархаан сум', 'Асгат сум (Завхан)', 'Баянтэс сум', 'Баянхайрхан сум (Завхан)', 'Дөрвөлжин сум (Завхан)', 'Завханмандал сум', 'Идэр сум', 'Их-Уул сум (Завхан)', 'Нөмрөг сум', 'Отгон сум', 'Сантмаргац сум', 'Сонгино сум (Завхан)', 'Тосонцэнгэл сум', 'Түдэвтэй сум', 'Тэлмэн сум', 'Ургамал сум', 'Цагаанхайрхан сум (Завхан)', 'Цагаанчулуут сум', 'Цэцэн-Уул сум', 'Шилүүстэй сум', 'Эрдэнэхайрхан сум (Завхан)', 'Яруу сум'],
  'Орхон': ['Баян-Өндөр сум', 'Жаргалант сум (Орхон)'],
  'Өвөрхангай': ['Арвайхээр сум', 'Баруунбаян-Улаан сум', 'Бат-Өлзий сум', 'Баян-Өндөр сум (Өвөрхангай)', 'Баянгол сум (Өвөрхангай)', 'Богд сум (Өвөрхангай)', 'Бүрд сум', 'Гучин-Ус сум', 'Долоон хошуу', 'Зүүнбаян-Улаан сум', 'Сант сум (Өвөрхангай)', 'Тарагт сум', 'Төгрөг сум (Өвөрхангай)', 'Уянга сум', 'Хархорин сум', 'Хайрхандулаан сум', 'Хужирт сум', 'Есөнзүйл сум'],
  'Өмнөговь': ['Даланзадгад сум', 'Баяндалай сум', 'Баян-Овоо сум (Өмнөговь)', 'Булган сум (Өмнөговь)', 'Гурвантэс сум', 'Мандал-Овоо сум', 'Манлай сум', 'Ноён сум', 'Номгон сум', 'Сэврэй сум', 'Ханбогд сум', 'Ханхонгор сум', 'Хүрмэн сум', 'Цогт-Овоо сум', 'Цогтцэций сум'],
  'Сүхбаатар': ['Баруун-Урт сум', 'Асгат сум (Сүхбаатар)', 'Баяндэлгэр сум (Сүхбаатар)', 'Дарьганга сум', 'Мөнххаан сум', 'Наран сум', 'Онгон сум', 'Сүхбаатар сум (Сүхбаатар)', 'Түмэнцогт сум', 'Түвшинширээ сум', 'Уулбаян сум', 'Халзан сум', 'Эрдэнэцагаан сум'],
  'Сэлэнгэ': ['Сүхбаатар сум (Сэлэнгэ)', 'Алтанбулаг сум (Сэлэнгэ)', 'Баруунбүрэн сум', 'Баянгол сум (Сэлэнгэ)', 'Жавхлант сум (Сэлэнгэ)', 'Зүүнбүрэн сум', 'Мандал сум (Сэлэнгэ)', 'Орхон сум (Сэлэнгэ)', 'Орхонтуул сум', 'Сайхан сум (Сэлэнгэ)', 'Сант сум (Сэлэнгэ)', 'Түшиг сум', 'Хүдэр сум', 'Хушаат сум (Сэлэнгэ)', 'Цагааннуур сум (Сэлэнгэ)', 'Шаамар сум'],
  'Төв': ['Зуунмод сум', 'Алтанбулаг сум (Төв)', 'Аргалант сум', 'Архуст сум', 'Батсүмбэр сум', 'Баян сум (Төв)', 'Баяндэлгэр сум (Төв)', 'Баянжаргалан сум (Төв)', 'Баян-Өнжүүл сум', 'Баянхангай сум', 'Баянцагаан сум (Төв)', 'Баянчандмань сум', 'Борнуур сум', 'Бүрэн сум (Төв)', 'Дэлгэрхаан сум (Төв)', 'Жаргалант сум (Төв)', 'Заамар сум', 'Лүн сум', 'Мөнгөнморьт сум', 'Өндөрширээт сум', 'Сэргэлэн сум (Төв)', 'Сүмбэр сум (Төв)', 'Угтаалцайдам сум', 'Цээл сум (Төв)', 'Эрдэнэ сум (Төв)', 'Эрдэнэсант сум'],
  'Увс': ['Улаангом сум', 'Баруунтуруун сум', 'Бөхмөрөн сум', 'Давст сум', 'Завхан сум (Увс)', 'Зүүнговь сум', 'Зүүнхангай сум', 'Малчин сум', 'Наранбулаг сум', 'Өлгий сум (Увс)', 'Өмнөговь сум (Увс)', 'Сагил сум', 'Тариалан сум (Увс)', 'Тэс сум (Увс)', 'Түргэн сум', 'Ховд сум (Увс)', 'Хяргас сум', 'Цагаанхайрхан сум (Увс)', 'Чандмань сум (Увс)'],
  'Ховд': ['Ховд сум (Ховд)', 'Алтай сум (Ховд)', 'Булган сум (Ховд)', 'Буянт сум (Ховд)', 'Дарви сум (Ховд)', 'Дөргөн сум', 'Дуут сум', 'Зэрэг сум', 'Манхан сум', 'Мөнххайрхан сум', 'Мөст сум', 'Мянгад сум', 'Үенч сум', 'Ховд сум (Ховд)', 'Цэцэг сум (Ховд)', 'Чандмань сум (Ховд)', 'Эрдэнэбүрэн сум'],
  'Хөвсгөл': ['Мөрөн сум', 'Алаг-Эрдэнэ сум', 'Арбулаг сум', 'Баянзүрх сум (Хөвсгөл)', 'Бүрэнтогтох сум', 'Галт сум (Хөвсгөл)', 'Жаргалант сум (Хөвсгөл)', 'Их-Уул сум (Хөвсгөл)', 'Рашаант сум (Хөвсгөл)', 'Рэнчинлхүмбэ сум', 'Тариалан сум (Хөвсгөл)', 'Тосонцэнгэл сум (Хөвсгөл)', 'Төмөрбулаг сум', 'Түнэл сум', 'Улаан-Уул сум', 'Ханх сум', 'Цагааннуур сум (Хөвсгөл)', 'Цагаан-Уул сум', 'Цагаан-Үүр сум', 'Цэцэрлэг сум (Хөвсгөл)', 'Чандмань-Өндөр сум', 'Шинэ-Идэр сум', 'Эрдэнэбулган сум (Хөвсгөл)'],
  'Хэнтий': ['Чингис хот (Өндөрхаан)', 'Батноров сум', 'Батширээт сум', 'Баян-Адрага сум', 'Баянмөнх сум (Хэнтий)', 'Баян-Овоо сум (Хэнтий)', 'Биндэр сум', 'Дадал сум', 'Дархан сум (Хэнтий)', 'Дэлгэрхаан сум (Хэнтий)', 'Жаргалтхаан сум', 'Мөрөн сум (Хэнтий)', 'Норовлин сум', 'Өмнөдэлгэр сум', 'Хэрлэнбаян-Улаан сум', 'Цэнхэрмандал сум'],
};
...
export default function PaymentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        `Захиалга #${orderNumber} амжилттай! Гүйлгээний утга: ${transferCode}. Төлбөрөө шилжүүлнэ уу.`,
        { style: { background: '#22c55e', color: 'white', border: 'none', borderRadius: '12px' }, duration: 10000 }
      );
      clearCart();
      ...
      <div className="flex items-center justify-center space-x-2 sm:space-x-4 w-full max-w-xs sm:max-w-sm">
        <div className="flex flex-col items-center">
          <button
            ...
            className={`flex items-center justify-center w-8 h-8 rounded-full ${step >= 1 ? 'bg-white text-black' : 'bg-neutral-800 text-neutral-400'} font-semibold transition-colors duration-300 ${step !== 1 ? 'cursor-pointer hover:bg-neutral-700 hover:text-white' : ''}`}
            disabled={step === 1 && !isSubmitting}
            aria-label="Go to Step 1: Shipping"
          >1</button>
        ...
        <div className="flex flex-col items-center">
          <button
            ...
            className={`flex items-center justify-center w-8 h-8 rounded-full ${step >= 2 ? 'bg-white text-black' : 'bg-neutral-800 text-neutral-400'} font-semibold transition-colors duration-300 ${step !== 2 ? 'cursor-pointer hover:bg-neutral-700 hover:text-white' : ''}`}
            disabled={(step === 2 && !isSubmitting) || isSubmitting}
            aria-label="Go to Step 2: Payment"
          >2</button>
  ...
  return (
    <div className="min-h-screen rounded-[2rem] border border-neutral-700 bg-neutral-950 text-neutral-100 py-12 md:py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto mb-6">
        <Button
          variant="ghost"
          onClick={() => step === 1 ? router.back() : handleStepNavigation(1)}
                          ...
                          <Select value={formData.province} onValueChange={(value) => handleSelectChange('province', value)}>
                            ...
                            <SelectContent className="bg-neutral-800 border-neutral-700 text-neutral-100 max-h-60">
                              {Object.keys(mongolianLocations).sort().map((province) => (
                                <SelectItem key={province} value={province} className="hover:bg-neutral-700 focus:bg-neutral-700">
                                  {province}
                                </SelectItem>
                              ))}
                            </SelectContent>
                          ...
                          <Select value={formData.district} onValueChange={(value) => handleSelectChange('district', value)} disabled={!formData.province}>
                            ...
                            <SelectContent className="bg-neutral-800 border-neutral-700 text-neutral-100 max-h-60">
                              {formData.province && mongolianLocations[formData.province]?.sort().map((district) => (
                                <SelectItem key={district} value={district} className="hover:bg-neutral-700 focus:bg-neutral-700">
                                  {district}
                                </SelectItem>
                              ))}
                            </SelectContent>
                  ...
                  <Card className="bg-neutral-900 border border-neutral-800 shadow-lg rounded-2xl overflow-hidden">
                    ...
                    <CardContent className="space-y-6 pt-6">
                          ...
                          {Object.entries(bankAccounts).map(([key, { name }]) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {isSelected && (<div className="absolute top-1.5 right-1.5 text-blue-400"><CheckCircle className="h-4 w-4" /></div>)}
                              </button>
                            );
                          })}
                        </div>
                      ...
                      {paymentMethod && bankAccounts[paymentMethod] && (
                        ...
                        >
                          <h3 className="font-medium text-indigo-300 mb-4 flex items-center gap-2 text-lg"><Landmark className="h-5 w-5 flex-shrink-0 text-indigo-400"/>Төлбөр хүлээн авагч</h3>
                          <dl className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-3 text-sm sm:text-base text-indigo-100 mb-5">
                            <dt className="font-medium text-indigo-300/90">Банк:</dt><dd className="text-indigo-100">{bankAccounts[paymentMethod].name}</dd>
                            <dt className="font-medium text-indigo-300/90 self-start pt-1">Данс:</dt><dd className="font-mono text-indigo-50 text-lg sm:text-xl tracking-wider bg-indigo-900/50 px-3 py-1 rounded-md w-fit">{bankAccounts[paymentMethod].number}</dd>
                            <dt className="font-medium text-indigo-300/90">Хүлээн авагч:</dt><dd className="text-indigo-100">{bankAccounts[paymentMethod].recipient}</dd>
                          </dl>
                  ...
                  <div className="space-y-4 mb-6 max-h-60 overflow-y-auto pr-2">
                    {cart.map((item: CartItem) => (
                      <div key={`${item.product.id}-${item.size}`} className="flex justify-between items-start">
                        ...
                        <p className="text-sm font-medium text-neutral-100 pl-2 flex-shrink-0">{(item.price * item.quantity).toLocaleString()}₮</p>
                      </div>
                    ))}
                  </div>
                ...
                <CardFooter className="bg-neutral-900/50 border-t border-neutral-800 pt-4">
                  {step === 1 ? (
                    <Button
                      ...
                      className="w-full py-6 text-base font-medium bg-white hover:bg-neutral-100 text-black rounded-full"
                    >
                    ...
                    <Button
                      ...
                      className="w-full py-6 text-base font-medium bg-blue-600 hover:bg-blue-500 text-white rounded-full disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
