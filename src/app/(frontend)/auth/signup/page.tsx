...
const SignupPage = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center font-sans bg-[#111111] text-white">
      ...
      {/* Main Signup Content - Divided into two halves */}
      <div className="flex w-full min-h-screen">
        {/* Left Half: Background Image */}
        <div
          className="hidden md:flex w-1/2 bg-cover bg-center"
          style={{ backgroundImage: 'url("https://cdn.cosmos.so/745b057c-5dec-459c-84a5-a7a48e11bee7?format=jpeg")' }} // <--- IMPORTANT: Replace with your image path
        >
          {/* Content for the left half, if any, will go here. */}
        </div>

        {/* Right Half: Signup Form */}
        <div className="w-full md:w-1/2 flex items-center justify-center p-4 bg-[#111111]">
          <div className="w-full max-w-sm mx-auto text-center">
            <h1 className="text-3xl font-semibold mb-8 text-white">Бүртгэл үүсгэх</h1>
            <form onSubmit={(e) => { e.preventDefault(); handleSignup(); }} className="space-y-4 text-left">
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-neutral-300 mb-1">И-мэйл хаяг</label>
                <input
                  type="email"
                  id="email"
                  value={email}
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-neutral-300 mb-1">Нууц үг</label>
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-neutral-300 mb-1">Нууц үгээ баталгаажуулах</label>
                <div className="relative">
                  <input
                    id="confirmPassword"
              ...
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-base font-medium text-black bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
